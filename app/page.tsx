...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      {/* Simple Header */}
      <header className="fixed top-0 left-0 right-0 z-50 bg-gray-900/90 backdrop-blur-md shadow-lg border-b border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <a href="/referral-links" className="text-gray-300 hover:text-blue-400 font-medium">Referral Links</a>
            </div>
          </div>
        </div>
      </header>
